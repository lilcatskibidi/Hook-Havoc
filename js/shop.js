const RARITY_LABELS = {
    ...
    mythic:    { label: 'Mythic',    color: '#e879f9' }   // added for your mythic tier
};
...
const Shop = {
    ...
    // ============================================================
    //  WEAPONS TAB (Backpack + Equip to 4 slots)
    // ============================================================
        ...
        WEAPONS.forEach((w, idx) => {
            ...
            if (!owned) {
                ...
                btn.onclick = () => {
                    ...
                    // Give starting ammo if the weapon uses ammo
    ...
    // ============================================================
    //  AMMO TAB — dynamic, based on owned weapons
    // ============================================================
    renderAmmo(state, content) {
        const p = state.player;

        // Build ammo list from owned weapons that use ammo (not Infinity)
        const ammoItems = WEAPONS
            ...
            .map(w => {
                ...
                return {
                    ...
                    name: `${w.name} Ammo`,
                    icon: w.icon,
                    unit,                                   // price per bullet
                    max,                                    // max capacity
                    pack: Math.max(10, Math.round(max / 4)) // buy amount = 25% of max, minimum 10
                };
            });
